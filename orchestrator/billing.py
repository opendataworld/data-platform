...
SERVICE_PRICING = {
    ...
    # Streaming
    "stream.kafka": ServicePricing(
        service_id="stream-kafka",
        service_name="Kafka Streaming",
        unit_price_cents=10,
        unit="1k_messages"
    ),
    "stream.redpanda": ServicePricing(
    ...
    # LangFlow/Low-Code
    "workflow.langflow": ServicePricing(
